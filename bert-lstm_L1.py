...
RESULTS_CSV = "results_10runs_bert_lstm_1_layer.csv"
...
# ============================
# 7) LSTM QA Model (TRUE ARCHITECTURE as requested) 1 LAYER
# ============================

class QALSTMModel(nn.Module):
    def __init__(self, input_size=768, hidden_size=512, dense_size=512):
        ...
        self.projection = nn.Linear(hidden_size, dense_size)
